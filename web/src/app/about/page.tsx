...
const team = [
  {
    ...
    bio:
      "With 15 years experience in healthcare product development, Kate oversaw the launch of " +
  ...
  },
  {
    ...
    bio:
      "John is the Former Chief of Innovation at CCA & WSV, and he's led tech-driven care models " +
  ...
  },
  {
    ...
    bio:
      "Glenda has been the founder and CEO of a healthcare venture... three times, including her venture Autism Health. " +
  ...
  },
  {
    ...
    bio:
      "Syntria is always on the search for amazing new talent like you! Reach out today if you're interested in shaping " +
    ...
    <main className="min-h-screen bg-light-bg text-dark-bg font-sans pb-20">
      ...
      <section className="max-w-4xl mx-auto pt-32 pb-12 px-4 text-center">
        ...
        <p className="text-xl max-w-2xl mx-auto mb-8 opacity-90 text-dtext">
          ...
          of video games, we create experiences that are both fun and
          scientifically proven to boost attention, memory, and focus. Our team
          is passionate about making a real impact—one game at a time.
        </p>
      </section>
      ...
      <section className="max-w-3xl mx-auto px-4 py-12 text-center">
        ...
        <p className="mb-6 text-lg opacity-90 text-dark-bg">
          We&apos;re always looking for new talent. Reach out today and make a
          difference!
        </p>
        <a
      ...
      <section className="max-w-3xl mx-auto px-4 py-12 text-center">
        ...
        <VerticalTimeline>
          ...
          >
            ...
            <br />
            <h6>
              8 independent studies and 6 additional publications are produced,
              all of which find that Skyla&apos;s Run improves cognition.
            </h6>
          </TimelineElement>
          <TimelineElement
          ...
          >
            ...
            <br />
            <h6>
              Thynk begins, taking over Skylar&apos;s Run and fueling more R&D
          ...
          >
            ...
            <br />
            <h6>
              Thynk launches pilot programs and begins a shift to early
              education.
            </h6>
          </TimelineElement>
          <TimelineElement
          ...
          >
            ...
            <h3 className="vertical-timeline-element-subtitle">
              Picks Up Skylar&apos;s Run
            </h3>
            <br />
            <h6>
              Skylar&apos;s Run assembles team and registers Syntria as an
              organization that brings distribution to healthcare innovation.
            </h6>
          </TimelineElement>
          <TimelineElement
          ...
          >
            ...
            <h3 className="vertical-timeline-element-subtitle">
              Continuing Cognitive Advancements
            </h3>
            <br />
            <h6>
              In order to bring economic incentive to new products, Syntria has
              focused on licensing out innovation from Thynk.
            </h6>
          </TimelineElement>
        </VerticalTimeline>
      </section>
