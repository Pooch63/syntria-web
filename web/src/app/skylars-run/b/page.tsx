    ...
    <main className="min-h-screen bg-light-bg text-dark-bg font-sans">
      ...
      <section className="py-24 bg-hcontrast relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-5">
          ...
          <div className="absolute bottom-20 right-10 w-40 h-40 bg-gradient-to-r from-rtrans to-ltrans rounded-full blur-3xl animate-pulse" style={{animationDelay: '1s'}}></div>
          <div className="absolute top-1/2 left-1/3 w-24 h-24 bg-gradient-to-r from-ltrans to-rtrans rounded-full blur-xl animate-pulse" style={{animationDelay: '2s'}}></div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4 text-center relative z-10">
          ...
          <SlideUpOnScroll>
            <div className="relative group">
              ...
              <div className="absolute -inset-1 bg-gradient-to-r from-ltrans to-rtrans rounded-3xl blur-lg opacity-30 group-hover:opacity-50 transition duration-500"></div>
              
              {/* Video container */}
              <div className="relative bg-white rounded-2xl shadow-2xl overflow-hidden border-4 border-white">
                {/* Video iframe */}
                <iframe
                  src="https://www.youtube.com/embed/dgz0HPeBtJk"
                  title="Skylar's Run Demo Video"
              ...
              <div className="absolute -top-6 -left-6 w-12 h-12 bg-gradient-to-br from-ltrans to-rtrans rounded-full opacity-20 animate-bounce" style={{animationDelay: '0.5s'}}></div>
              <div className="absolute -bottom-4 -right-4 w-8 h-8 bg-gradient-to-br from-rtrans to-ltrans rounded-full opacity-30 animate-bounce" style={{animationDelay: '1.5s'}}></div>
              <div className="absolute top-10 -right-8 w-6 h-6 bg-gradient-to-br from-ltrans to-rtrans rounded-full opacity-25 animate-bounce" style={{animationDelay: '2.5s'}}></div>
            </div>
          </SlideUpOnScroll>
          ...
          <SlideUpOnScroll>
            <div className="mt-12 max-w-4xl mx-auto">
              <div className="bg-hcontrast backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-ltrans">
                <h3 className="text-2xl font-bold text-dark-bg mb-4">
                  Revolutionary Neurofeedback Gaming
                </h3>
                <p className="text-lg text-ltext opacity-80 leading-relaxed text-balance">
                  Our EEG technology seamlessly integrates with gameplay, 
                  creating an immersive experience where mental focus directly controls character movement. 
                  Watch as real brain activity transforms into engaging, therapeutic gaming.
                </p>
              </div>
            </div>
          </SlideUpOnScroll>
